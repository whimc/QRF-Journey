...
-- 66 cross-world tunnels
-- Skipped portals:
--   Shuttle2Station: same-world (elevator/intra-world)
--   rocket-elevator: same-world (elevator/intra-world)
--   obstut_towertp1: same-world (elevator/intra-world)
--   obstut_towertp2: same-world (elevator/intra-world)
--   obstut_towertp3: same-world (elevator/intra-world)
--   obstut_towertp4: same-world (elevator/intra-world)
--   obstut_next: same-world (elevator/intra-world)
--   obstut_goback: same-world (elevator/intra-world)
--   DomeFix: same-world (elevator/intra-world)
--   return2dome: same-world (elevator/intra-world)
--   hub-elevator-up: same-world (elevator/intra-world)
--   hub-elevator-dn: same-world (elevator/intra-world)
--   hub2build: no destination
--   rocket-tower-elevator: same-world (elevator/intra-world)
--   TwoMoons2TwoMoonsLow: same-world (elevator/intra-world)
--   PBS-elevator-bottom: same-world (elevator/intra-world)
--   PBS-elevator-top: same-world (elevator/intra-world)
--   cancri-elevator: same-world (elevator/intra-world)
--   cancricloudup: same-world (elevator/intra-world)
--   summer2hub: same-world (elevator/intra-world)
--   other2hub: same-world (elevator/intra-world)
--   planetarium2hub: same-world (elevator/intra-world)
--   nova2hub: same-world (elevator/intra-world)
--   cancri-exit-clouds: same-world (elevator/intra-world)
--   AIchoice2nomoon: same-world (elevator/intra-world)
--   warptwo: same-world (elevator/intra-world)
--   tiltedmelting2warm: same-world (elevator/intra-world)
--   tiltedwarmhelolaunch: same-world (elevator/intra-world)
--   tiltedwarmheloreturn: same-world (elevator/intra-world)
--   tiltedmeltinghelolaunch: same-world (elevator/intra-world)
--   tiltedmeltingheloreturn: same-world (elevator/intra-world)
--   tiltedfrozenhelolaunch: same-world (elevator/intra-world)
--   tiltedfrozenheloreturn: same-world (elevator/intra-world)
--   celestial: same-world (elevator/intra-world)
--   celestial2hub: same-world (elevator/intra-world)
--   continuedplay: same-world (elevator/intra-world)
--   solo1: unknown origin world 'eval'
--   solo2: unknown origin world 'eval'
--   solo3: unknown origin world 'eval'
--   solo4: unknown origin world 'eval'
--   solo5: unknown origin world 'eval'
--   solo6: unknown origin world 'eval'
--   solo7: unknown origin world 'eval'
--   solo8: unknown origin world 'eval'
--   solo9: unknown origin world 'eval'
--   solo10: unknown origin world 'eval'
--   solo11: unknown origin world 'eval'
--   solo12: unknown origin world 'eval'
--   solo13: unknown origin world 'eval'
--   solo14: unknown origin world 'eval'
--   solo15: unknown origin world 'eval'
--   solo16: unknown origin world 'eval'
--   solo17: unknown origin world 'eval'
--   solo18: unknown origin world 'eval'
--   solo19: unknown origin world 'eval'
--   solo20: unknown origin world 'eval'
--   pair1: unknown origin world 'eval'
--   pair2: unknown origin world 'eval'
--   pair3: unknown origin world 'eval'
--   pair4: unknown origin world 'eval'
--   pair5: unknown origin world 'eval'
--   pair6: unknown origin world 'eval'
--   pair7: unknown origin world 'eval'
--   pair8: unknown origin world 'eval'
--   pair9: unknown origin world 'eval'
--   pair10: unknown origin world 'eval'
--   pair11: unknown origin world 'eval'
--   pair12: unknown origin world 'eval'
--   pair13: unknown origin world 'eval'
--   pair14: unknown origin world 'eval'
--   pair15: unknown origin world 'eval'
--   pair16: unknown origin world 'eval'
--   pair17: unknown origin world 'eval'
--   pair18: unknown origin world 'eval'
--   pair19: unknown origin world 'eval'
--   pair20: unknown origin world 'eval'