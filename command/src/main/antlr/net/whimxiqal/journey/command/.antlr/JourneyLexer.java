...
public class JourneyLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"ADMIN", "BUILD", "CACHE", "CANCEL", "CLEAR", "COLON", "DEBUG", "FALSE", 
			"INVALIDATE", "JOURNEY", "JOURNEY_TO", "LIST_NETHER_PORTALS", "LIST_WAYPOINTS", 
			"PATH", "PATHS", "PLAYER", "PORTALS", "PUBLIC", "RELOAD", "RENAME", "SERVER", 
			"SET", "SET_WAYPOINT", "TRUE", "UNSET", "WAYPOINT", "FLAG_ANIMATE", "FLAG_DIG", 
			"FLAG_DOOR", "FLAG_FLY", "FLAG_NAVIGATOR", "FLAG_TIMEOUT", "OPEN_BRACE", 
			"CLOSED_BRACE", "ID", "SINGLE_QUOTE", "DOUBLE_QUOTE", "WS"
		};
	}
	...
	public JourneyLexer(CharStream input) {
		super(input);
